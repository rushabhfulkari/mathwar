...
class DivisionLevel1 extends StatefulWidget {
  @override
  _DivisionLevel1State createState() => _DivisionLevel1State();
}

class _DivisionLevel1State extends State<DivisionLevel1> {
  ...
  Widget build(BuildContext context) {
    ...
    int randomNumber2 = random.nextInt(100) + randomNumber1;
    double div =
        double.parse((randomNumber2 / randomNumber1).toStringAsFixed(2));

    int randomNumber3 = random.nextInt(2);
    int randomNumber4 = random.nextInt(3) + 1;

    run1 ? randomnumber = randomNumber3 : null;
    run1
        ? randomNumber3 == 1
            ? earlier = "$randomNumber2 / $randomNumber1 = $div"
            : earlier =
                "$randomNumber2 / $randomNumber1 = ${div + randomNumber4}"
        : null;
                ...
                child: Container(
                  ...
                  child: run1
                      ? run
                          ? randomNumber3 == 1
                              ? Text(
                                  "$randomNumber2 / $randomNumber1 = $div",
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                      fontSize: h / 25,
                                      fontFamily: "Chicken",
...
class _DivisionLevel2State extends State<DivisionLevel2> {
  ...
  Widget build(BuildContext context) {
    ...
    double w = MediaQuery.of(context).size.width;
    AudioCache player = new AudioCache(fixedPlayer: audioplayer);
    int randomNumber1 = random.nextInt(30) + 1;
    int randomNumber2 = random.nextInt(300) + randomNumber1;
...
class DivisionLevel3 extends StatefulWidget {
  @override
  _DivisionLevel3State createState() => _DivisionLevel3State();
}

class _DivisionLevel3State extends State<DivisionLevel3> {
  final audioplayer = AudioPlayer();
  // AudioCache player = new AudioCache(fixedPlayer: audioplayer);
  ...
  Widget build(BuildContext context) {
    ...
    int randomNumber2 = random.nextInt(500) + randomNumber1;
