...
class SubtractionLevel1 extends StatefulWidget {
  @override
  _SubtractionLevel1State createState() => _SubtractionLevel1State();
}

class _SubtractionLevel1State extends State<SubtractionLevel1> {
  ...
  Widget build(BuildContext context) {
    ...
    int randomNumber1 = random.nextInt(100) + randomNumber2;
    ...
    run1
        ? randomNumber3 == 1
            ? earlier = "$randomNumber1 - $randomNumber2 = $sub"
            : earlier =
                "$randomNumber1 - $randomNumber2 = ${(sub - randomNumber4).abs()}"
        : null;
                ...
                child: Container(
                  ...
                  child: run1
                      ? run
                          ? randomNumber3 == 1
                              ? Text(
                                  "$randomNumber1 - $randomNumber2 = $sub",
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                      fontSize: h / 25,
                                      fontFamily: "Chicken",
...
class _SubtractionLevel2State extends State<SubtractionLevel2> {
  ...
  Widget build(BuildContext context) {
    ...
    int randomNumber1 = random.nextInt(1000) + randomNumber2;
    int sub = randomNumber1 - randomNumber2;
    int randomNumber3 = random.nextInt(2);
...
class SubtractionLevel3 extends StatefulWidget {
  @override
  _SubtractionLevel3State createState() => _SubtractionLevel3State();
}

class _SubtractionLevel3State extends State<SubtractionLevel3> {
  final audioplayer = AudioPlayer();
  // AudioCache player = new AudioCache(fixedPlayer: audioplayer);
  ...
  Widget build(BuildContext context) {
    ...
    int randomNumber1 = random.nextInt(10000) + randomNumber2;
    int sub = randomNumber1 - randomNumber2;
    int randomNumber3 = random.nextInt(2);
